...
export const otpSmsSettingsTable = pgTable("otp_sms_settings", {
  ...
  destinationCountry: text("destination_country").notNull().default("IN"),
  otpTemplateText: text("otp_template_text").default("Your login OTP is ##OTP##. Valid for 5 minutes. Do not share."),
