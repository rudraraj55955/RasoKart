...
// ── PUT /api/iam/users/:userId/permissions/bulk ─────────────────────────────
// IMPORTANT: registered BEFORE /:permissionKey so Express does not capture
// the literal string "bulk" as a permissionKey value.
