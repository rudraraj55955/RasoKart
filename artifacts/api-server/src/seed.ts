  ...
  try {
    const RAZORPAY_CAPABILITY_PRODUCTS: Array<typeof providerProductsTable.$inferInsert> = [
      ...
      },
      {
        ...
        implNotes: "Admin-initiated refund management implemented. Refunds stored in razorpay_refunds table. Normal and Optimum speed supported.",
      ...
      },
      {
        ...
        status: "coming_soon",
        sortOrder: 5,
        capabilityStatus: "VERIFICATION_REQUIRED",
        officialApiAvailable: true,
        officialSdkAvailable: false,
        testModeStatus: "not_configured",
        ...
        merchantAccess: false,
        customerFacingModule: false,
        implNotes: "Settlements API (GET /v1/settlements, GET /v1/settlements/{id}) available post-account-verification. Settlement data sync not yet implemented. Enable settlement.processed webhook to populate the settlement overview cache.",
      ...
      },
      {
        ...
        merchantAccess: false,
        customerFacingModule: false,
        implNotes: "Smart Collect Virtual Accounts require a banking partner agreement (ICICI/Yes Bank). Additional verification needed. Not yet implemented.",
      ...
      },
      {
        ...
        merchantAccess: false,
        customerFacingModule: true,
        implNotes: "Invoice API is public but limited vs dashboard. Not yet implemented.",
      ...
      },
      {
        ...
        merchantAccess: false,
        customerFacingModule: true,
        implNotes: "Razorpay Checkout JS loaded from checkout.razorpay.com on the payment page. Handles all payment methods automatically.",
      ...
      },
      {
        ...
        merchantAccess: false,
        customerFacingModule: false,
        implNotes: "RazorpayX Payouts API requires separate account activation (RAZORPAY_X_KEY_ID + RAZORPAY_X_SECRET). Run the RazorpayX Verification check on the Analytics page to confirm activation status.",
      ...
      },
      {
        ...
        merchantAccess: false,
        customerFacingModule: false,
        implNotes: "Fund Accounts (beneficiaries) are prerequisites for RazorpayX Payouts. Requires the same RazorpayX activation as razorpayx_payouts.",
