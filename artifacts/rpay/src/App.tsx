...
import AdminMerchantConnect from "@/pages/admin/merchant-connect";
import AdminMerchantEnrollments from "@/pages/admin/merchant-enrollments";
...
import AdminPayuOrders from "@/pages/admin/payu-orders";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/merchant/signup"><Redirect to="/merchant/apply" /></Route>
      ...
      <Route path="/signup-now"><Redirect to="/merchant/apply" /></Route>
      <Route path="/get-started"><Redirect to="/merchant/apply" /></Route>
      <Route path="/onboard"><Redirect to="/merchant/apply" /></Route>
      <Route path="/open-account"><Redirect to="/merchant/apply" /></Route>
      ...
      <Route path="/admin/merchant-connect"><AdminRoute component={AdminMerchantConnect} /></Route>
      <Route path="/admin/merchant-enrollments"><AdminRoute component={AdminMerchantEnrollments} /></Route>
      ...
      <Route path="/admin/payu-orders"><AdminRoute component={AdminPayuOrders} /></Route>
