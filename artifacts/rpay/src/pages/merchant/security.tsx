...
const PREF_FIELD_LABELS: Record<string, string> = {
  ...
  ekqrSyncAlertEmails: "UPI sync alerts (email)",
  ...
  ekqrSyncAlertNotifs: "UPI sync alerts (in-app)",
...
export default function MerchantSecurity() {
  ...
  const disabledNotifications = me == null ? [] : [
    ...
    ...(!ekqrSyncAlertEnabled ? ["UPI sync alerts (email)"] : []),
    ...(!ekqrSyncAlertNotifsEnabled ? ["UPI sync alerts (in-app)"] : []),
