...
// In GitHub Actions CI the playwright install step correctly downloads and
// manages its own chromium — passing executablePath there would point to the
// missing Nix store path and fail every test.
const isCI = process.env["GITHUB_ACTIONS"] === "true";

const CHROMIUM_EXECUTABLE: string | undefined =
